ctgui_help_catalog <- function() {
  list(
    ...
    help_uncertainty_method = list(topic = "ctOptimUncertainty", param = "uncertainty", tooltip = "Method used to approximate optimized-fit uncertainty. Hessian is the standard fast choice; bootstrap and importance sampling can take substantially longer."),
    ...
    help_uncertainty_control = list(topic = "ctOptimUncertainty", param = "control", tooltip = "Advanced method-specific controls. The defaults match ctsem's optimized uncertainty defaults."),
